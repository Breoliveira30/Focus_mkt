      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="#inicio" className="flex items-center space-x-3">
            <div className="relative w-12 h-12 rounded-full bg-primary p-1 overflow-hidden hidden sm:block">
              <Image
                src="/images/logo.png"
            ...
            <span className="text-white font-bold text-xl hidden sm:inline">Focus Marketing Digital</span>

            <div className="flex items-center sm:hidden">
              <span className="text-white font-bold text-2xl">F</span>
              <div className="relative w-8 h-8 mx-0.5 rounded-full overflow-hidden bg-primary">
                <Image src="/images/logo.png" alt="Focus Logo" fill className="object-cover rounded-full" />
              </div>
              <span className="text-white font-bold text-2xl">CUS</span>
            </div>
          </Link>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-white/10">
            <nav className="flex flex-col space-y-4">
              ...
              <Button asChild className="bg-secondary text-primary hover:bg-secondary/90 font-semibold w-full">
